...
- **Filebeat logs information about the file system, including which files have changed and when.  It can collect logs generated by Apache, Microsoft Azure, Nginx, or MySQL, which we can use to identify suspecious activities.**
![TODO: Update the path with the name of your diagram](Diagrams/HW13_FilebeatScreenshot.png)

- **Metricbeat records machine metrics, which we can use to track uptime.**
